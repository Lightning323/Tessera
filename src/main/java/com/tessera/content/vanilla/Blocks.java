...
import com.tessera.content.vanilla.blocks.blocks.*;
import com.tessera.engine.client.Client;
import com.tessera.engine.client.ClientWindow;
import com.tessera.engine.server.builtinMechanics.gravityBlock.GravityBlock;
import com.tessera.engine.server.ItemUtils;
...
import com.tessera.content.vanilla.blocks.blocks.trees.*;

import java.io.IOException;
import java.util.ArrayList;

import static com.tessera.content.vanilla.blocks.PlantBlockUtils.GROW_PROBABILITY;
import static com.tessera.engine.server.ItemUtils.getJsonBlocksFromResource;
import static com.tessera.engine.common.math.RandomUtils.random;
...
public class Blocks {
    ...
    public static ArrayList<Block> starup_getBlocks() {
        ...
        ArrayList<Block> blockList = getJsonBlocksFromResource("/data/tessera/blocks/json");
        //Add blocks
...
//                PlantBlockUtils.logRemovalEvent(log, Registrys.getBlock(Blocks.BLOCK_OAK_LEAVES)));
    ...
    private static void randomTickEvents() {
        ...
        plantUtils.makeStalk(
                Registrys.getBlock("tessera:bamboo"),
                Registrys.getBlock("tessera:bamboo_sapling"),
                15,
                (block) -> {//Growable
        ...
        plantUtils.makeStalk(
                Registrys.getBlock("tessera:sugar_cane"), null,
                8,
                (block) -> {//growable
                    return plantUtils.blockIsSandOrGravel(block);
                });
