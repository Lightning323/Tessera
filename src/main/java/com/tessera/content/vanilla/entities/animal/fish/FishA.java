...
public class FishA extends FishAnimal {
    ...
    public void loadDefinitionData(boolean hasData, JsonParser parser, JsonNode node) throws IOException {
        ...
        if (body == null) {
            body = new EntityMesh();
            body.loadFromOBJ(resourceLoader.getResourceAsStream("assets/tessera/allEntities\\animal\\fish\\fish_A.obj"));
            String[] textureFiles = ResourceLister.listSubResources("assets/tessera/allEntities\\animal\\fish\\textures\\fish_A");
