...
import com.tessera.engine.server.block.construction.DefaultBlockType;
import com.tessera.engine.server.builtinMechanics.liquid.LiquidBlockType;
import com.tessera.engine.server.item.blockIconRendering.BlockIconRenderer;
import com.tessera.utils.IntMap;
...
public class BlockRegistry {
    ...
    public void setup(List<Block> blockArray) throws IOException {
        ...
        textures = new BlockArrayTexture("/assets/tessera/textures/block/");
