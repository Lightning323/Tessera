...
import com.tessera.engine.client.visuals.gameScene.rendering.entity.EntityShader;
import com.tessera.engine.client.visuals.gameScene.rendering.entity.EntityShader_ArrayTexture;
...
import com.tessera.engine.common.world.wcc.WCCf;
...
import com.tessera.utils.resource.ResourceLoader;
import com.tessera.engine.common.worldInteraction.collision.EntityAABB;
...
import static com.tessera.engine.common.json.JsonManager.SMILE_HEADER;
...
public abstract class Entity {
    ...
    public boolean playerIsRidingThis() {
        return Client.userPlayer.positionLock != null && Client.userPlayer.positionLock.entity == this;
    }
